  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-8xl mx-auto">
        {/* Header Skeleton */}
        <div className="mb-12">
          <div className="h-10 w-64 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-700 rounded-2xl mb-6 animate-pulse" />
            ...
            <div key={i} className="relative">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="h-8 w-24 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-700 rounded-xl animate-pulse" />
                </div>
              </div>
            </div>
          ))}
