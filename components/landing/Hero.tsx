...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex items-center overflow-hidden bg-linear-to-b from-white via-gray-50/50 to-white dark:from-gray-900 dark:via-gray-900/95 dark:to-gray-900"
    >
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 -left-40 w-96 h-96 bg-linear-to-tr from-green-500/5 to-cyan-500/5 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 left-1/3 w-96 h-96 bg-linear-to-tl from-orange-500/5 to-pink-500/5 rounded-full blur-3xl" />

        {/* Grid Pattern */}
        <div className="absolute inset-0 opacity-5 dark:opacity-10 bg-[radial-gradient(circle_at_1px_1px,rgba(0,0,0,0.1)_1px,transparent_0)] dark:bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.1)_1px,transparent_0)] bg-size-[40px_40px]" />
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 border border-blue-500/20 dark:border-blue-500/30 mb-8"
            >
            ...
            >
              <Link
                href="/products"
                className="group px-8 py-4 bg-linear-to-r from-gray-900 to-gray-800 dark:from-white dark:to-gray-200 text-white dark:text-gray-900 rounded-2xl flex items-center justify-center gap-3 font-semibold hover:shadow-2xl hover:scale-[1.02] transition-all duration-300"
              >
          ...
          >
            <div className="relative h-150">
                  ...
                  >
                    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl h-full overflow-hidden border border-white/30 dark:border-white/10">
                      ...
                      <div className="relative h-2/3 overflow-hidden">
                        <div className="absolute inset-0 bg-linear-to-b from-transparent to-black/10 z-10" />
                        <img
                          src={product.image}
                          alt={product.title}
                        ...
                        {/* Discount Badge */}
                        {product.discount && (
                          <div className="absolute top-6 right-6 bg-linear-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-full font-bold text-sm">
                            -{product.discount}%
                          </div>
                        )}
                      ...
                      <div className="p-8">
                        ...
                        <div className="mt-6 flex justify-between items-center">
                          ...
                          <button className="group flex items-center gap-3 bg-linear-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300">
              ...
              {/* Glow Effect */}
              <div className="absolute -inset-4 bg-linear-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-3xl rounded-3xl -z-10" />
            </div>
          </motion.div>
        </div>
      </div>
