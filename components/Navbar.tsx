  ...
  return (
    <header
      className={`
        ...
        ${
          scrolled
            ? "bg-white/90 dark:bg-[rgb(0,10,0)]/90 backdrop-blur-xl border-b border-white/20 dark:border-gray-800/50 shadow-lg shadow-black/5 py-3"
            : "bg-transparent py-6"
        }
      `}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -inset-1 rounded-xl border border-[rgb(91,199,97)]/30"
            />
          </motion.div>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-[rgb(91,199,97)] font-medium tracking-widest uppercase">
              Premium
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <button className="group relative overflow-hidden px-5 py-2.5 rounded-full bg-gradient-to-r from-[rgb(91,199,97)] via-[rgb(75,170,80)] to-[rgb(91,199,97)] text-white dark:text-gray-900 font-medium text-sm hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300">
